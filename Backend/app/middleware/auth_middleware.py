...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: RequestResponseEndpoint) -> Response:
        from app.middleware.request_logging import _mw_log, _safe_error_response

        _mw_log("Authentication", request, "entered")
        try:
            ...
            _mw_log("Authentication", request, "exited")
            return response
        except Exception as exc:
            _mw_log("Authentication", request, "exception", exc)
